...
class Calendar(HTMLCalendar):
    ...
    def formatday(self, day, shifts):
        ...
        for shift in shifts_per_day:
            d+=f'<li> {shift.physicianOnCall.lastName} </li>'
    ...
    def formatmonth(self, withyear=True):
        shifts = McsaShift.objects.filter(start_time__year=self.year, start_time__month=self.month)
